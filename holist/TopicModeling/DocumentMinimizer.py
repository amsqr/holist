...
#stopWords += ["reuters", "company", "market", "billion", "million", "dollars", "percent", "share", "mln", "dlrs", "pct", "bln"]
#stopWords += ["vs","net","loss","cts","gain"]

DBdict = None

def init():
    global DBdict, stopWords
    DBdict = DatabaseDictionary.DatabaseDictionary()
    stopWords = set(map(stem,stopWords))

def minimize(doc, numTerms=None):
...
def getDocumentAsVector(document):
    ...
    return DBdict.doc2bow(document, allow_update=True)